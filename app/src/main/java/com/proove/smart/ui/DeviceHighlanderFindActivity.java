...
public class DeviceHighlanderFindActivity extends BaseActivity<ActivityDeviceFindBinding> implements OnMapReadyCallback {
    ...
    public static void start(String name, String mac, Activity activity) {
        Intent intent = new Intent(activity, DeviceHighlanderFindActivity.class);
    ...
    protected void initView() {
        ...
        binding.tvSound.setText(R.string.sound_signal);
    ...
    private void getPlay() {
        ...
        if (binding.llPlayStop.isSelected()) {
            ...
            if (!viewModel.isConnected(mac)) {
                ToastUtil.showToast(DeviceHighlanderFindActivity.this, getString(R.string.not_connected_device));
            } else {
                showRingTipDialog();
            }
        }
